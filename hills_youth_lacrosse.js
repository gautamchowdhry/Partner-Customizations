  ...
  var url = $(location).attr('href');  
    ...
    if(url.indexOf('/registration?bid=') > -1){ 
      ...
      if (regCount){
        ...
        // 2nd registration an more get a $25 discount
        if (regCount >= 1) {          
          var newText = 'Congratulations. You qualify for our <strong>sibling discount</strong>.  You\'ll <strong>save $25</strong> on this registration.'
          $("h2:contains('Discount Code')").after('<div class="participant-headsup">' +newText + '</span>');
          $('#discountCode').val('sibling25');
