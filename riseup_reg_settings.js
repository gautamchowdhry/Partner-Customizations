$(window).load(function(){
  var url = $(location).attr('href');  
    ...
    if(url.indexOf('/signup') > -1){      
        ...
        $('#ga-intro #page-title').next().html('This page is asking you for your information, as the account owner. This will be the account that manages all the registrations, payments and actions regarding your team(s) participation. You will register your teams in the next step.');                            
        $('#fam-detail').hide();
     ...
     if(url.indexOf('/registration/context') > -1){  
        $("h1:contains('Select a Child')").text('Select a Program & Register');
          ...
          $("h4:contains('Coaches tied')").after('<h4>Select your name below to begin.</h4>');
          $("#add-supervisor").hide();
    ...
    if(url.indexOf('/registration?') > -1){  
          ...
          $("h1:contains('League Registration Terms')").text('Tournament Registration Terms & Waiver');
