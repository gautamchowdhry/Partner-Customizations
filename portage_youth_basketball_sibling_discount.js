  ...
  var url = $(location).attr('href');  
    ...
    if(url.indexOf('/registration?bid=') > -1){ 
      ...
      if (regCount){
        ...
        if (regCount == 2) {          
          var newText = 'Congratulations. You qualify for our <strong>three player sibling discount</strong>.  You\'ll <strong>save $25</strong> on this registration.'
          $("h2:contains('Discount Code')").after('<div class="participant-headsup">' +newText + '</span>');
          $('#discountCode').val('3rdchild');
          $("#discountCode").attr('readonly', true);
          $("#discountCode").attr("style", "background: #CCC; color: #333;border: 1px solid #666");
        }  
