    ...
    if(url.indexOf('/registration?bid=') > -1){ 
      ...
      if (user_id) {
        var headers = {
          ...
          'x-api-key': '3dbe9d159a5cc631b80da2f6d076f1b9'
          };
          ...
          headers: headers
            ...
            if (pageTitle.toLowerCase().indexOf("league") > -1) {
                ...
                if (regCount == 1) {
                 ...
                 if (regCount >= 2) {
                  var newText = 'Congratulations. You qualify for our <strong>multi player sibling discount</strong>.  This registration is <b>free</b>.'
                  $('[data-id="discount-code"]').after('<div class="participant-headsup">' +newText + '</span>');
                  $('#discountCode').val('FamilyMax');
                  $("#discountCode").attr('readonly', true);
                  $("#discountCode").attr("style", "background: #CCC; color: #333;border: 1px solid #666");                       
                }
