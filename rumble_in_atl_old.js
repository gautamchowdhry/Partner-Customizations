  ...
  var url = $(location).attr('href');  
    ...
    if(url.indexOf('/registration?bid=') > -1){ 
      ...
      if (regCount){
        ...
        // 2nd registration
        if (regCount == 1) {          
          var newText = 'Congratulations. You qualify for our <strong>two team discount</strong>.  You\'ll <strong>save $50</strong> on this registration.'
