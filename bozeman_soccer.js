    ...
    if(url.indexOf('/registration?bid=') > -1){ 
      ...
      if (user_id) {
        var headers = {
          ...
          'x-api-key': 'de70aee917441dcb4bfba1ee404cd74b'
          };
          ...
          headers: headers
            ...
            for (var i = 0, len = data.length; i < len; i++) {
              ...
              if (reg.programState != 'COMPLETED' && reg.userType == 'ADULT') {                
                if (reg.programId == '83678' || reg.programId == '83679') // ONLY APPLY FOR PROGRAMS
                    regCount++;                
                }
                                           }
           }
           ...
           if(url.indexOf('bid=83678') > -1 || url.indexOf('bid=83679') > -1){ 
             //2nd registration
              if (regCount >= 1) {
                var newText = 'Congratulations. You qualify for our <strong>multi program discount</strong>.  You\'ll <strong>save $50</strong> on this registration.'
