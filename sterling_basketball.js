    ...
    if(url.indexOf('/registration?bid=') > -1){ 
      ...
      if (user_id) {
        var headers = {
          ...
          'x-api-key': 'c9b08315cf405c18c0abbbc478a43b0b'
          };
        ...
        $.ajax(site_url + '/users/' + user_id + '/registrations', {
          ...
          headers: headers
            ...
            for (var i = 0, len = data.length; i < len; i++) {
              var reg = data[i];                            
              if (reg.programState != 'COMPLETED' && reg.userType == 'CHILD' &&  reg.programType == 'CAMP') {                
                regCount++;                
              }
           }
            ...
            if (pageTitle.toLowerCase().indexOf("camp") > -1) {
                ...
                if (regCount == 1) {                
                  ...
                  $('#discountCode').val('2ndsiblingsbaclinic');
                ...
                if (regCount == 2) {                
                  ...
                  $('[data-id="discount-code"]').after('<div class="participant-headsup">' +newText + '</span>');
                  $('#discountCode').val('3rdsiblingsbaclinic');
                  $("#discountCode").attr('readonly', true);
                  $("#discountCode").attr("style", "background: #CCC; color: #333;border: 1px solid #666");                       
                }
                ...
                if (regCount >= 3) {                
                  ...
                  $('[data-id="discount-code"]').after('<div class="participant-headsup">' +newText + '</span>');
                  $('#discountCode').val('4thsiblingsbaclinic');
                  $("#discountCode").attr('readonly', true);
                  $("#discountCode").attr("style", "background: #CCC; color: #333;border: 1px solid #666");                       
                }
