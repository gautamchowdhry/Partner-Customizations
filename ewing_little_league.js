  ...
  var url = $(location).attr('href');  
    ...
    if(url.indexOf('/registration?bid=') > -1){ 
      ...
      if (regCount){
        ...
        // 2nd registration
        if (regCount == 1) {          
          var newText = 'Congratulations. You qualify for our <strong>two player sibling discount</strong>.  You\'ll <strong>save $20</strong> on this registration.'
        ...
        if (regCount == 2) {          
          var newText = 'Congratulations. You qualify for our <strong>three player sibling discount</strong>.  You\'ll <strong>save $40</strong> on this registration.'
          $("h2:contains('Discount Code')").after('<div class="participant-headsup">' +newText + '</span>');
