$(document).ready(function() {  
  ...
  $("strong.step-name:contains('Products')").text("Raffle");
  ...
  var url = $(location).attr('href');  
     ...
     if(url.indexOf('/products') > -1){       
         ...
         $('[data-id="products-title"]').text("Raffle");
         ...
         if (purch == 'true') {
            ...
            var nText = 'Your raffle has already been selected. Please click continue and skip to move forward to the payment page';
